...
const educations: TimelineItem[] = [
  {
    ...
    title: "이젠아카데미",
    company: "프론트엔드 웹 퍼블리셔 · UX/UI 디자이너 양성과정 수료",
    skills: ["HTML", "CSS", "JavaScript", "TypeScript", "React", "Redux"],
    details: [
      "반응형 웹 퍼블리싱부터 화면 기획·UI 구현까지 웹 서비스 전반을 실습하며 프로젝트 중심으로 역량 강화",
      "컴포넌트 기반 설계와 재사용성을 중심으로 한 프론트엔드 아키텍처 실습 및 UI/UX 개선 프로세스 경험",
      "팀 프로젝트 기획·설계 및 코드 리뷰를 통한 협업 방식 체득",
    ],
  },
  {
    id: "edu-2",
    period: "2018 - 2022",
    title: "동양미래대학교",
    company: "전공 수업 및 프로젝트 기반의 실무 기초 역량 확보",
    skills: ["전공 프로젝트", "팀 협업", "문서화", "프레젠테이션"],
    details: [
      "전공 프로젝트를 통해 서비스 기획부터 설계·구현까지의 기본 개발 프로세스 경험",
      "문서화·발표 중심의 팀 프로젝트를 수행하며 협업 및 커뮤니케이션 역량 강화",
    ],
  },
  {
    id: "edu-3",
    period: "2019 - 2020",
    title: "호주 워킹홀리데이",
    company: "현지 문화·업무 경험을 통한 커뮤니케이션 및 적응력 강화",
    skills: ["영어 커뮤니케이션", "적응력", "문제 해결"],
    details: [
      "다양한 국적의 동료들과 협업하며 실무 중심의 영어 커뮤니케이션 능력 향상",
      "문화/디자인/사용자 이해에 대한 경험의 폭이 넗어지고 인사이트 확장",
    ],
  }
];
    ...
    >
      <div className="mx-auto max-w-5xl px-6">
        ...
        >
          ...
          <h2 className="text-[26px] sm:text-[26px] font-bold leading-tight">
