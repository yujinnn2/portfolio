  ...
  },
  {
    ...
    content: () => (
      <p>
        ...
        village of Khant Maanpur in Punjab, India, he has become a cultural
        icon in the Punjabi music industry. <br /> <br /> His songs often
        reflect the struggles and triumphs of everyday life, capturing the
        essence of Punjabi culture and traditions. With a career spanning over
        two decades, Babu Maan has released numerous hit albums and singles that
...
export function ExpandableCardDemo() {
  ...
  return (
    <>
        ...
        {active ? (
          <div className="fixed inset-0 z-[100] grid place-items-center">
            ...
            <motion.div
              ...
              ref={ref}
              className="flex h-full w-full max-w-[500px] flex-col overflow-hidden bg-white dark:bg-neutral-900 md:h-fit md:max-h-[90%] sm:rounded-3xl"
            >
              ...
              <div>
                ...
                <div className="relative px-4 pt-4">
                  <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    className="
                      flex h-40 flex-col items-start gap-4 pb-10
                      text-xs text-neutral-600 md:h-fit md:text-sm lg:text-base
      ...
      {/* 리스트 카드 */}
      <ul className="mx-auto w-full max-w-6xl px-6 gap-4">
        {cards.map((card) => (
          <motion.div
            ...
            className="
              flex cursor-pointer flex-col items-center justify-between
              rounded-xl p-4
          ...
          >
            ...
            <motion.button
              ...
              className="
                mt-4 rounded-full bg-gray-100 px-4 py-2 text-sm font-bold text-black
                hover:bg-green-500 hover:text-white md:mt-0
              "
            >
              {card.ctaText}
            </motion.button>
